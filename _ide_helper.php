...
namespace {
    ...
    class Auth extends \Illuminate\Support\Facades\Auth{
         ...
         *
         * @return \App\Repositories\User\User|null 
         * @static 
         */
         ...
         * @param mixed $id
         * @param bool $remember
         * @return \App\Repositories\User\User 
         * @static 
         */
    ...
    class FormMaker extends \Yab\Laracogs\Facades\FormMaker{
         ...
         * @static 
         */
        public static function fromTable($table, $columns = null, $class = 'form-control', $view = null, $reformatted = true, $populated = false, $idAndTimestamps = false){
            return \Yab\Laracogs\Utilities\FormMaker::fromTable($table, $columns, $class, $view, $reformatted, $populated, $idAndTimestamps);
        }
         ...
         * @static 
         */
        public static function fromArray($array, $columns = null, $view = null, $class = 'form-control', $populated = true, $reformatted = false, $idAndTimestamps = false){
            return \Yab\Laracogs\Utilities\FormMaker::fromArray($array, $columns, $view, $class, $populated, $reformatted, $idAndTimestamps);
        }
         ...
         * @static 
         */
        public static function fromObject($object, $columns = null, $view = null, $class = 'form-control', $populated = true, $reformatted = false, $idAndTimestamps = false){
            return \Yab\Laracogs\Utilities\FormMaker::fromObject($object, $columns, $view, $class, $populated, $reformatted, $idAndTimestamps);
        }
         ...
         * @static 
         */
        public static function getTableColumns($table, $allColumns = false){
            return \Yab\Laracogs\Utilities\FormMaker::getTableColumns($table, $allColumns);
        }
        
    }


    class InputMaker extends \Yab\Laracogs\Facades\InputMaker{
         ...
         * @static 
         */
        public static function create($name, $field, $object = null, $class = 'form-control', $reformatted = false, $populated = true){
            return \Yab\Laracogs\Utilities\InputMaker::create($name, $field, $object, $class, $reformatted, $populated);
        }
         ...
         * @static 
         */
        public static function label($name, $attributes = array()){
            return \Yab\Laracogs\Utilities\InputMaker::label($name, $attributes);
        }
        ...
        public static function cleanString($string){
            return \Yab\Laracogs\Utilities\InputMaker::cleanString($string);
        }
        
    }


    class Crypto extends \Yab\Laracogs\Utilities\Crypto{
    ...
    class Markdown extends \AlfredoRamos\ParsedownExtra\Facades\ParsedownExtra{
        ...
        public static function parse($text, $options = array()){
            return \AlfredoRamos\ParsedownExtra\ParsedownExtraLaravel::parse($text, $options);
        }
        ...
        public static function text($text){
            ...
            return \AlfredoRamos\ParsedownExtra\ParsedownExtraLaravel::text($text);
        }
        ...
        public static function setBreaksEnabled($breaksEnabled){
            ...
            return \AlfredoRamos\ParsedownExtra\ParsedownExtraLaravel::setBreaksEnabled($breaksEnabled);
        }
        ...
        public static function setMarkupEscaped($markupEscaped){
            //Method inherited from \Parsedown            
            return \AlfredoRamos\ParsedownExtra\ParsedownExtraLaravel::setMarkupEscaped($markupEscaped);
        }
        ...
        public static function setUrlsLinked($urlsLinked){
            //Method inherited from \Parsedown            
            return \AlfredoRamos\ParsedownExtra\ParsedownExtraLaravel::setUrlsLinked($urlsLinked);
        }
        ...
        public static function line($text){
            //Method inherited from \Parsedown            
            return \AlfredoRamos\ParsedownExtra\ParsedownExtraLaravel::line($text);
        }
